...
import styles from '../components/MyMenu.module.css';
...
<div className="ruby-col-4 ruby-col-6-md" style={{ paddingLeft: '10px' }}>
<ul>
...
<div className="ruby-col-4 hidden-md" style={{ paddingLeft: '15px' }}>
<ul>
...
<li className="ruby-menu-mega-blog"><a href="#">Blog</a>
               <div style={{ height: '269.359px' }} className="">
                ...
                <li className="hidden-md"><a href="#">Blog-3-Column</a>
                  <div className="ruby-grid ruby-grid-lined" style={{ height: '263px' }}>
                    <div className="ruby-row">
                ...
                <li><a href="#">Blog-Article-List</a>
                  <div className="ruby-grid ruby-grid-lined" style={{ height: '263px' }}>
                    <div className="ruby-row">
                      <div className="ruby-col-6">
                        <span className="ruby-c-title" style={{ marginBottom: '15px' }}>POPULAR THREADS</span>
                        <div className="ruby-row">
                      ...
                      <div className="ruby-col-6">
                        <span className="ruby-c-title" style={{ marginBottom: '15px' }}>MOST COMMENTED</span>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-1.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">An Erupting Volcano And A Meteor Has Created A Fantastic View</a></span></div>
                        </div>
                  ...
                  <div className="ruby-grid ruby-grid-lined">
                    <div className="ruby-row">
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style={{ marginTop: '16px' }}>EYEWEAR</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style={{ marginTop: '16px' }}>JEWELLERY</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style={{ marginTop: '16px' }}>WATCHES</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style={{ marginTop: '16px' }}>OTHERS</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
